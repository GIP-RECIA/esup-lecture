...
public class DomainServiceImpl implements DomainService, InitializingBean {
    ...
    /**
     * @see
     * org.esupportail.lecture.domain.DomainService#setTreeSize(UserProfile,
     * String, int)
     */
    @Override
    ...
    /**
     * @see
     * org.esupportail.lecture.domain.DomainService#foldCategory(UserProfile,
     * String, String)
     */
    @Override
    ...
    /**
     * @see
     * org.esupportail.lecture.domain.DomainService#unfoldCategory(UserProfile,
     * String, String)
     */
    @Override
    ...
    private List<SourceBean> getVisibleSources(final CategoryBean categoryBean, final UserProfile userProfile)
        ...
        try {
            ...
            String errorMsg = "CustomCategoryNotFound for service 'getVisibleSources(user "
                    + userProfile.getUserId() + ", category " + catId + ")"
                    + "User " + userProfile.getUserId() + " is not subscriber of Category " + catId;
            LOG.error(errorMsg);
            throw new InternalDomainException(errorMsg, e);
        }
        return listSourceBean;
    ...
    /**
     * @see
     * org.esupportail.lecture.domain.DomainService#updateSQL(java.lang.String)
     */
    @Override
    ...
    /**
     * @see
     * org.esupportail.lecture.domain.DomainService#setDatabaseVersion(java.lang.String)
     */
    @Override
    ...
    /**
     * @see
     * org.esupportail.lecture.domain.DomainService#getContext(java.lang.String,
     * java.lang.String)
     */
    @Override
